(() => {
              ...
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  default:
                    ...
                    return apply3(map5(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
  ...
  function _observe(element, options2, observer) {
    observer.observe(element, options2);
  }
  ...
  var unsafeReadProp = function(dictMonad) {
    ...
    return function(k) {
      return function(value12) {
        return unsafeReadPropImpl(fail2(new TypeMismatch("object", typeOf(value12))), pure3, k, value12);
      };
    };
  };
  ...
  var modify3 = function(dictIsSymbol) {
  ...
  var printBoxOption = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Web.ResizeObserver (line 40, column 18 - line 43, column 54): " + [v.constructor.name]);
  };
  var observe = function() {
    return function() {
      return function(element) {
        var $26 = runEffectFn3(_observe)(element);
        var $27 = modify4($$Proxy.value)(printBoxOption);
        var $28 = flip(merge2)({
  ...
  var normalizeEntry = function(entry) {
    var readBoxSize = function(boxSize) {
      return apply2(map4(function(blockSize) {
      ...
      })(bind2(readProp2("blockSize")(boxSize))(readNumber2)))(bind2(readProp2("inlineSize")(boxSize))(readNumber2));
    };
    var normalizeBoxSize = function(boxSize) {
      return fromRight([])(runExcept(alt5(bind2(readArray2(boxSize))(traverse2(readBoxSize)))(alt5(map4(singleton2)(readBoxSize(boxSize)))(pure2([])))));
    };
    return {
      target: entry.target,
  ...
  var observe2 = /* @__PURE__ */ observe()();
  var main = function __do() {
    var win = windowImpl();
    var doc = document(win)();
    var maybeBody = body(doc)();
    if (maybeBody instanceof Just) {
      var htmlDoc = toDocument(doc);
      var el = createElement("div")(htmlDoc)();
      setAttribute("style")("\n            height:100px;\n            background:#000;\n            color:#fff;\n            display:flex;\n            align-items:center;\n            justify-content:center;\n            font:48px sans-serif;\n          ")(el)();
      var outputWidth = function(w) {
        return setTextContent(toString(w) + "px")(toNode(el));
      };
      appendChild(toNode(el))(toNode2(maybeBody.value0))();
      var observer = resizeObserver(function() {
        var $12 = traverse_2(function($14) {
          return outputWidth(function(v) {
            return v.contentRect.width;
          }($14));
        });
        return function($13) {
          return $$const($12($13));
    ...
    if (maybeBody instanceof Nothing) {
      return $$throw("Could not find body element.")();
    }
    ;
    throw new Error("Failed pattern match at Example.Main (line 29, column 3 - line 53, column 43): " + [maybeBody.constructor.name]);
  };
